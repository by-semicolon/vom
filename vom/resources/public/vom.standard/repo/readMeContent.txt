...
still have permission to delete your implementation but you'll still
have a chance to copy it locally before it's gone).
...
vom  init  [location]  [--force]  ---------------------------------------------- create your own vom repository, pass --force to recreate it
     ...
     impl  go  <name>  --------------------------------------------------------- go to a specific implementation. command cannot be used if
...
vom  add  <file>  -------------------------------------------------------------- add a file or directory to the current implementation's track
     ...
     revert  [id]  [--force]  -------------------------------------------------- revert to the last commit or the commit with the specified
