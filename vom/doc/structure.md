...
(parent)/
  .shw/
    whatisthis.md # contains info about vom for those who might not know what this directory is.
    .git/
    info/
      contributors.json # contains an object of all contributors on this repository along with their first contribution, number of contributions, list of owned implementations, bio, contact and links.
    ...
    implementations/
      (implementation name)/
        info/
          owner.etxt # the username of the owner of the implementation
